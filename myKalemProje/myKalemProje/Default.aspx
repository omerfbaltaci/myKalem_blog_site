                    ...
                    <ItemTemplate>
                        <div class="content-grid">
                            <div class="content-grid-info">
                                ...
                                <div class="post-info">
                                    <h4><a href="MakaleDetay.Aspx?MAKALEID=<%# Eval("MAKALEID")%>"><%# Eval("MAKALEBASLIK") %></a> <%# Eval("MAKALEYAZAR")%> &nbsp;&nbsp;&nbsp; <%# Eval("MAKALETARIH")%> </h4>
                                    <p><%# Eval("MAKALEICERIK")%></p>
                                    <a href="MakaleDetay.Aspx?MAKALEID=<%# Eval("MAKALEID")%>"><span></span>Yorumları Gör</a>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
